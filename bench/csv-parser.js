...
function peg$parse(input, options) {
  ...
  let peg$startRuleFunction = peg$parseCSV;
  ...
  function peg$f0(lines, last) {
    if (last.length === 1 && last[0] === '') return lines
    return [...lines, last]
  }
  function peg$f1(row, nl) {    return row  }
  function peg$f2(head, f) {    return f  }
  function peg$f3(head, tail) {    return [head, ...tail]  }
  function peg$f4(parts) {    return parts.join('')  }
  ...
  function peg$parseCompleteLine() {
    let s0, s1, s2;
  ...
  function peg$parseField() {
    ...
    s0 = peg$parseQuotedField();
    if (s0 === peg$FAILED) {
      s0 = peg$parseUnquotedField();
    }

    return s0;
  }

  function peg$parseQuotedField() {
    let s0, s1, s2, s3;
  ...
  function peg$parseUnquotedField() {
    let s0, s1, s2;
