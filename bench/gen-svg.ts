  ...
  groups: [
    {
      ...
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/455757,  color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/391772,  color: C.peggy },
        { label: 'Parséman (no compile)',  us: 1e6/355759,  color: C.noCompile },
        { label: 'Parsimmon',              us: 1e6/164985,  color: C.parsimmon },
        { label: 'Chevrotain',             us: 1e6/133280,  color: C.chevrotain },
        { label: 'JSON.parse (native)',    us: 1e6/5725436, color: C.native },
      ],
    },
    {
      title: 'warm parse — medium  (1.8 kB)',
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/15929,  color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/15088,  color: C.peggy },
        { label: 'Parséman (no compile)',  us: 1e6/12151,  color: C.noCompile },
        { label: 'Parsimmon',              us: 1e6/5252,   color: C.parsimmon },
        { label: 'Chevrotain',             us: 1e6/4159,   color: C.chevrotain },
        { label: 'JSON.parse (native)',    us: 1e6/261556, color: C.native },
      ],
    },
    {
      title: 'warm parse — large  (12 kB)',
      bars: [
        { label: 'Peggy',                  us: 1e6/2131,   color: C.peggy },
        { label: 'Parséman (macro build)', us: 1e6/1709,   color: C.macroBuild },
        { label: 'Parséman (no compile)',  us: 1e6/1312,   color: C.noCompile },
        { label: 'Parsimmon',              us: 1e6/676,    color: C.parsimmon },
        { label: 'Chevrotain',             us: 1e6/523,    color: C.chevrotain },
        { label: 'JSON.parse (native)',    us: 1e6/22732,  color: C.native },
      ],
    },
  ],
}
  ...
  groups: [
    {
      ...
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/1745980, color: C.macroBuild },
        { label: 'Parséman (no compile)',  us: 1e6/525753,  color: C.noCompile },
        { label: 'Peggy',                  us: 1e6/498824,  color: C.peggy },
        { label: 'Parsimmon',              us: 1e6/280145,  color: C.parsimmon },
        { label: 'Chevrotain',             us: 1e6/154150,  color: C.chevrotain },
      ],
    },
    {
      title: 'warm parse — large  (14.8 kB, 500 rows)',
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/10752,  color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/2327,   color: C.peggy },
        { label: 'Parsimmon',              us: 1e6/2236,   color: C.parsimmon },
        { label: 'Parséman (no compile)',  us: 1e6/3001,   color: C.noCompile },
        { label: 'Chevrotain',             us: 1e6/804,    color: C.chevrotain },
      ],
    },
  ],
}
  ...
  groups: [
    {
      ...
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/872781, color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/426285, color: C.peggy },
        { label: 'Parséman (no compile)',  us: 1e6/264231, color: C.noCompile },
        { label: 'Chevrotain',             us: 1e6/228437, color: C.chevrotain },
        { label: 'Parsimmon',              us: 1e6/88941,  color: C.parsimmon },
      ],
    },
    {
      title: 'warm parse — medium  (336 bytes)',
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/137812, color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/62198,  color: C.peggy },
        { label: 'Parséman (no compile)',  us: 1e6/46520,  color: C.noCompile },
        { label: 'Chevrotain',             us: 1e6/38792,  color: C.chevrotain },
        { label: 'Parsimmon',              us: 1e6/17702,  color: C.parsimmon },
      ],
    },
    {
      title: 'warm parse — large  (7.8 kB)',
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/5510,  color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/2695,  color: C.peggy },
        { label: 'Parséman (no compile)',  us: 1e6/1724,  color: C.noCompile },
        { label: 'Chevrotain',             us: 1e6/1349,  color: C.chevrotain },
        { label: 'Parsimmon',              us: 1e6/639,   color: C.parsimmon },
      ],
    },
  ],
}
