  ...
  groups: [
    {
      ...
      bars: [
        { label: 'Parséman (macro build)', us: 0.99,   color: C.macroBuild },
        { label: 'Parséman (no compile)',  us: 1.79,   color: C.noCompile },
        { label: 'Jison',                  us: 6.50,   color: C.jison },
        { label: 'Nearley',                us: 7.12,   color: C.nearley },
        { label: 'Peggy',                  us: 2.69,   color: C.peggy },
        { label: 'Parsimmon',              us: 6.50,   color: C.parsimmon },
        { label: 'Chevrotain',             us: 7.91,   color: C.chevrotain },
    ...
    },
    {
      ...
      bars: [
        { label: 'Parséman (macro build)', us: 28.92,  color: C.macroBuild },
        { label: 'Jison',                  us: 203.18, color: C.jison },
        { label: 'Peggy',                  us: 68.48,  color: C.peggy },
        { label: 'Parséman (no compile)',  us: 54.77,  color: C.noCompile },
        { label: 'Nearley',                us: 307.98, color: C.nearley },
        { label: 'Parsimmon',              us: 197.34, color: C.parsimmon },
        { label: 'Chevrotain',             us: 250.39, color: C.chevrotain },
        { label: 'JSON.parse (native)',    us: 3.90,   color: C.native },
      ],
    },
    {
      title: 'warm parse — large  (12 kB)',
      bars: [
        { label: 'Parséman (macro build)', us: 249.37, color: C.macroBuild },
        { label: 'Jison',                  us: 1652.80,color: C.jison },
        { label: 'Peggy',                  us: 478.18, color: C.peggy },
        { label: 'Parséman (no compile)',  us: 465.87, color: C.noCompile },
        { label: 'Nearley',                us: 2604.64,color: C.nearley },
        { label: 'Parsimmon',              us: 1516.26,color: C.parsimmon },
        { label: 'Chevrotain',             us: 1937.53,color: C.chevrotain },
        { label: 'JSON.parse (native)',    us: 45.55,  color: C.native },
      ],
    },
  ],
}
  ...
  groups: [
    {
      ...
      bars: [
        { label: 'Parséman (macro build)', us: 0.35,  color: C.macroBuild },
        { label: 'Peggy',                  us: 2.04,  color: C.peggy },
        { label: 'Parséman (no compile)',  us: 2.39,  color: C.noCompile },
        { label: 'Parsimmon',              us: 3.70,  color: C.parsimmon },
        { label: 'Chevrotain',             us: 6.63,  color: C.chevrotain },
        { label: 'Nearley',                us: 7.94,  color: C.nearley },
      ],
    },
    {
      title: 'warm parse — large  (14.8 kB, 500 rows)',
      bars: [
        { label: 'Parséman (macro build)', us: 68.17,  color: C.macroBuild },
        { label: 'Peggy',                  us: 432.32, color: C.peggy },
        { label: 'Parsimmon',              us: 449.91, color: C.parsimmon },
        { label: 'Parséman (no compile)',  us: 409.62, color: C.noCompile },
        { label: 'Chevrotain',             us: 1259.19,color: C.chevrotain },
        { label: 'Nearley',                us: 2793.25,color: C.nearley },
      ],
    },
  ],
}
  ...
  groups: [
    {
      ...
      bars: [
        { label: 'Parséman (macro build)', us: 0.84,  color: C.macroBuild },
        { label: 'Peggy',                  us: 2.39,  color: C.peggy },
        { label: 'Jison',                  us: 6.70,  color: C.jison },
        { label: 'Nearley',                us: 6.75,  color: C.nearley },
        { label: 'Parséman (no compile)',  us: 4.49,  color: C.noCompile },
        { label: 'Chevrotain',             us: 4.41,  color: C.chevrotain },
        { label: 'Parsimmon',              us: 11.42, color: C.parsimmon },
      ],
    },
    {
      title: 'warm parse — medium  (336 bytes)',
      bars: [
        { label: 'Parséman (macro build)', us: 5.62,  color: C.macroBuild },
        { label: 'Peggy',                  us: 16.04, color: C.peggy },
        { label: 'Jison',                  us: 42.20, color: C.jison },
        { label: 'Nearley',                us: 42.18, color: C.nearley },
        { label: 'Parséman (no compile)',  us: 25.68, color: C.noCompile },
        { label: 'Chevrotain',             us: 26.24, color: C.chevrotain },
        { label: 'Parsimmon',              us: 58.17, color: C.parsimmon },
      ],
    },
    {
      title: 'warm parse — large  (7.8 kB)',
      bars: [
        { label: 'Parséman (macro build)', us: 142.01, color: C.macroBuild },
        { label: 'Peggy',                  us: 379.90, color: C.peggy },
        { label: 'Jison',                  us: 1271.83,color: C.jison },
        { label: 'Nearley',                us: 1457.08,color: C.nearley },
        { label: 'Parséman (no compile)',  us: 693.37, color: C.noCompile },
        { label: 'Chevrotain',             us: 744.02, color: C.chevrotain },
        { label: 'Parsimmon',              us: 1580.80,color: C.parsimmon },
      ],
    },
  ],
}
