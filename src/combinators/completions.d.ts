 ...
 *
 * Runs the combinator on input truncated at `offset` with a probe that tracks the
 ...
 */
export declare function completionsAt(combinator: Combinator<unknown>, input: string, offset: number): string[];
